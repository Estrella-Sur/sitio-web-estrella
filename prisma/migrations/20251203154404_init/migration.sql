...
-- CreateEnum
CREATE TYPE "public"."TransparencyCategory" AS ENUM ('ACCOUNTABILITY', 'ANNUAL_REPORTS', 'AUDIT_REPORTS');

-- CreateEnum
CREATE TYPE "public"."ResourceCategory" AS ENUM ('MULTIMEDIA_CENTER', 'PUBLICATIONS');

-- CreateEnum
CREATE TYPE "public"."ResourceSubcategory" AS ENUM ('VIDEOS', 'AUDIOS', 'INVESTIGATIONS', 'METHODOLOGICAL_RESOURCES', 'SYSTEMATIZATION_DOCUMENTS');
