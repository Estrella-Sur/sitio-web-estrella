...
export default function TransparencyPage() {
  ...
  return (
    <div className="min-h-screen bg-background-light dark:bg-background-dark">
      ...
      <section className="py-16 text-white dark:text-white relative overflow-hidden" style={{ backgroundColor: '#006a86' }}>
        <div className="absolute inset-0 opacity-10">
          <div className="absolute top-20 left-10 w-32 h-32 bg-white rounded-full blur-3xl"></div>
          <div className="absolute top-40 right-20 w-24 h-24 bg-blue-200 rounded-full blur-2xl"></div>
          <div className="absolute bottom-20 left-1/3 w-40 h-40 bg-blue-200 rounded-full blur-3xl"></div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="text-center">
            <Link href="/contacto?tab=complaint#formularios">
              <Button 
                size="lg" 
                className="bg-white hover:bg-gray-100 font-semibold px-6 py-3"
                style={{ color: '#006a86' }}
              >
